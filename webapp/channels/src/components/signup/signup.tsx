        ...
        return (
            <p className='signup-body-message-subtitle'>
                {formatMessage({
                    ...
                    defaultMessage: 'Create your Simulanis Connect account to start collaborating with your team',
                })}
            </p>
        );
    };
        ...
        if (cwsAvailability === CSWAvailabilityCheckTypes.Available) {
            return (
                <CheckInput
                    ...
                    text={
                        formatMessage(
                            {id: 'newsletter_optin.checkmark.text', defaultMessage: '<span>I would like to receive Simulanis Connect security updates via newsletter.</span> By subscribing, I consent to receive emails from Simulanis Connect with product updates, promotions, and company news. I have read the <a>Privacy Policy</a> and understand that I can <aa>unsubscribe</aa> at any time'},
                            {
        ...
        return (
            <div className='newsletter'>
                <span className='interested'>
                    {formatMessage({id: 'newsletter_optin.title', defaultMessage: 'Interested in receiving Simulanis Connect security, product, promotions, and company updates updates via newsletter?'})}
                </span>
                <span className='link'>
                    {formatMessage(
