            ...
            errorMessage = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='Simulanis Connect was unable to load because a setting in your browser prevents the use of its local storage features. To allow Simulanis Connect to load, try the following actions:'
                    />
                    <ul>
                        <li>
                            <FormattedMessage
                ...
                <div>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='For {link} make sure the administrator of your Microsoft organization has enabled the Simulanis Connect app.'
                            values={{
                                link: (
                                    <ErrorLink
            ...
            errorMessage = (
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage='You must authorize Simulanis Connect to log in with {service}.'
                        values={{
                            service,
                        }}
                    />
