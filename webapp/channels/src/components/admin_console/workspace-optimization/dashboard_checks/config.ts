...
const ssl = (
    ...
    return {
        ...
        description: formatMessage({
            ...
            defaultMessage: 'We strongly recommend securing your Simulanis Connect workspace by configuring SSL in production environments.',
        }),
...
const fileStorage = async (
    ...
    return {
        ...
        description: formatMessage({
            ...
            defaultMessage: 'Check your file storage settings to ensure your Simulanis Connect workspace has access to the configured file storage.',
        }),
