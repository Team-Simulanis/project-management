...
const getAccessData = async (
    ...
    description: formatMessage({
        ...
        defaultMessage: 'Web server configuration may be affecting access to your Simulanis Connect workspace.',
    }),
    hide: options.isCloud,
    descriptionOk: formatMessage({
...
const getEaseOfManagementData = async (
    ...
    description: formatMessage({
        ...
        defaultMessage: 'Make it easier to manage your Simulanis Connect workspace.',
    }),
    descriptionOk: formatMessage({
