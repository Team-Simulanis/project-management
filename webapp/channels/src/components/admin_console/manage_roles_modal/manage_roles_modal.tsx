                    ...
                    <div className='checkbox'>
                        <label>
                            ...
                            <FormattedMessage
                                ...
                                defaultMessage='Access to post to all Simulanis Connect channels including direct messages.'
                            />
                        </label>
                    </div>
                    <div className='checkbox'>
                        <label>
                            ...
                            <FormattedMessage
                                ...
                                defaultMessage='Access to post to all Simulanis Connect public channels.'
                            />
                        </label>
                    </div>
                </div>
