            ...
            <div>
                ...
                <p className='upgrade-legal-terms'>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='By clicking **Upgrade**, I agree to the terms of the Simulanis Connect '
                    />
                    <a
                        role='button'
                        onClick={openEEModal}
            ...
            <div>
                <p>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='You have upgraded your binary to Simulanis Connect enterprise, please restart the server to start using the new binary. You can do it right here:'
                    />
                </p>
                <p>
                    <button
