    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Integrate SAML 2.0 with Simulanis Connect Professional',
            })}
            copy={defineMessage({
                id: 'admin.saml_feature_discovery.copy',
                defaultMessage: 'When you connect Simulanis Connect with your organization\'s single sign-on provider, users can access Simulanis Connect without having to re-enter their credentials.',
            })}
