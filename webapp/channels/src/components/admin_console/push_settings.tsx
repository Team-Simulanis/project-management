        ...
        if (this.state.pushNotificationServerType === PUSH_NOTIFICATIONS_OFF) {
            ...
            pushServerHelpText = (
                <FormattedMessage
                    ...
                    defaultMessage='Download <linkIOS>Simulanis Connect iOS app</linkIOS> from iTunes. Download <linkAndroid>Simulanis Connect Android app</linkAndroid> from Google Play. Learn more about the <linkHPNS>Simulanis Connect Hosted Push Notification Service</linkHPNS>.'
                    values={{
                        linkIOS: (msg) => (
                            <ExternalLink
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-8'>
                        ...
                        <FormattedMessage
                            ...
                            defaultMessage=' I understand and accept the Simulanis Connect Hosted Push Notification Service <linkTerms>Terms of Service</linkTerms> and <linkPrivacy>Privacy Policy</linkPrivacy>.'
                            values={{
                                linkTerms: (msg) => (
                                    <ExternalLink
