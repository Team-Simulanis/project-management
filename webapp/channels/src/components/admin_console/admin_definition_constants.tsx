    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='Simulanis Connect will connect over an insecure connection.'
            />
        </td>
    </tr>
);
    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='Encrypts the communication between Simulanis Connect and your server.'
            />
        </td>
    </tr>
);
                ...
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The Simulanis Connect server will serve static files compressed with gzip.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The Simulanis Connect server will serve static files uncompressed.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The Simulanis Connect server will not serve static files.'
                        />
                    </td>
                </tr>
            </tbody>
